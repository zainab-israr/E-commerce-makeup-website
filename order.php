...
<div class="m">
	...
	<div class="b">
     <p class="title">Order Cancellation Policy</p>
      <div><p>You may cancel your order at any time before the order has been processed. Once the product has been shipped,
		      you will receive the tracking information and our "Exchange Policy" will apply.</p>
      </div>
      <div><p><b>e.l.f. may cancel orders for any reason. Common reasons include: the item is out of stock,
		   price errors or the credit card payment is declined by the issuing financial institution.</p>
      </div>
    </div> 
	 <div class="s"></div>
